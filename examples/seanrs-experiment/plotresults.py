...
def plot_link_load_vs_topology(
    resultset, alpha, cache_size, topology_range, strategies, plotdir
):
    """
...
def run(config, results, plotdir):
    ...
    for topology in topologies:
        for cache_size in cache_sizes:
            ...
            logger.info(
                "Plotting link load for topology %s vs cache size %s"
                % (topology, str(cache_size))
            )
    ...
    for topology in topologies:
        for alpha in alphas:
            ...
            logger.info(
                "Plotting link load for topology %s and alpha %s vs cache size"
                % (topology, str(alpha))
            )
    ...
    for cache_size in cache_sizes:
        for alpha in alphas:
            ...
            logger.info(
                "Plotting link load for cache size %s vs alpha %s against topologies"
                % (str(cache_size), str(alpha))
            )
